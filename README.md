...
- `README.md` – producer_consumer/README.md` for setup, tests, and sample console output.
- `tests/`
  - `test_blocking_queue.py` – Unit tests for `BlockingQueue`, including blocking behavior on full/empty
  - `test_producer_consumer.py` – Unit tests for producer and consumer logic, and integration tests for the full pipeline
...
### `dataset_reference/` - https://www.kaggle.com/datasets/ishanshrivastava28/superstore-sales/data.
...
### `README.md` – sales_data_analysis/README.md` for setup, tests, and sample console output.
